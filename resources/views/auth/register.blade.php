...
<div class="min-w-screen min-h-screen flex items-center justify-center px-5 py-5">
    <div class="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden" style="max-width:1000px">
        <div class="md:flex w-full">
            ...
            <div class="w-full bg-white md:w-1/2 py-10 px-5 md:px-10">
          
                <div class="flex items-center   dark:bg-gray-900">
                    <div class="container mx-auto">
                        <div class="max-w-md mx-auto my-10">
                            <div class="text-center">
                                <h1 class="my-3 text-3xl font-semibold text-gray-700 dark:text-gray-200">Регистрация</h1>
                                <p class="text-gray-500 dark:text-gray-400">Введите свои данные для регистрации</p>
                            </div>
                            <div class="m-7">
                                <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                                    {{ csrf_field() }}
            
                                    <div class="mt-2{{ $errors->has('user') ? ' has-error' : '' }}">
                                        <label for="user" class="block mb-2 text-sm text-gray-600 dark:text-gray-400">Логин</label>
                                    ...
                                    <div class="mt-2{{ $errors->has('first_name') ? ' has-error' : '' }}">
                                        <label for="first_name" class="block mb-2 text-sm text-gray-600 dark:text-gray-400">Имя</label>
                                    ...
                                    <div class="mt-2{{ $errors->has('last_name') ? ' has-error' : '' }}">
                                        <label for="last_name" class="block mb-2 text-sm text-gray-600 dark:text-gray-400">Фамилия</label>
                                     ...
                                     <div class="mt-2{{ $errors->has('email') ? ' has-error' : '' }}">
                                    ...
                                    <div class="mt-2{{ $errors->has('password') ? ' has-error' : '' }}">
                                        <label for="password" class="block mb-2 text-sm text-gray-600 dark:text-gray-400">Пароль</label>
                                    ...
                                    <div class="mt-2">
                                        <label for="password-confirm" class="block mb-2 text-sm text-gray-600 dark:text-gray-400">Подтвердите пароль</label>
            
                                        <div class="col-md-8">
                                            <input id="password-confirm" type="password" class="w-full px-3 py-2 placeholder-gray-300 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-100 focus:border-indigo-300 dark:bg-gray-700 dark:text-white dark:placeholder-gray-500 dark:border-gray-600 dark:focus:ring-gray-900 dark:focus:border-gray-500" name="password_confirmation" required>
                                        </div>
                                    </div>

                                    <div class="mt-4">
                                        <div class="flex flex-col sm:flex-row sm:justify-between items-center">
                                            <button class="px-3 py-3 rounded bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white font-semibold" type="submit">Зарегистрироваться</button>
                                            <a class="inline-block align-baseline  text-indigo-500 hover:text-indigo-800 font-semibold" href="/login">
                                            Авторизоваться
                                            </a>
                                          </div>
